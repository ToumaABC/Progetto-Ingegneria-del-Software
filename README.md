...
Questo sistema è una piattaforma software sviluppata in Python nata come **progetto per il corso di Ingegneria del Software**, dedicata esclusivamente alla gestione e alla ricerca di alloggi per studenti universitari. L'obiettivo principale è offrire strumenti completi e dedicati sia per i locatori che per gli studenti.
...
Il terminale ti mostrerà un indirizzo (solitamente `[http://127.0.0.1:5000](http://127.0.0.1:5000)`). Apri questo link nel browser per navigare nella piattaforma!
